                  ...
                  ContentWrapper(
                    ...
                    child: Row(
                      children: [
                        ...
                        TrailingInfo(
                        width: assignWidth(context: context, fraction: 0.05), // Adjust to make it narrower
...
Widget _buildPortfolioGallery() {
  return ListView.builder(
    ...
    itemBuilder: (context, index) {
      if (index >= 4) return Container(); // Return an empty container if index is >= 4
      return FadeTransition(
        ...
        child: Container(
          margin: EdgeInsets.only(
            bottom: assignHeight(context: context, fraction: 0.02),
          ),
          child: PortfolioCard(
            ...
            onTap: () {
              _navigateToProjectDetail(
                projectDetails: ProjectDetails(
                  ...
                  hasBeenReleased: Data.portfolioData[index].hasBeenReleased,
                  ...
                  pdf: Data.portfolioData[index].pdf,
                ),
              );
            },
            height: assignHeight(context: context, fraction: 0.6),
            width: assignWidth(context: context, fraction: 0.56), // Adjust this to fill the row
          ),
        ),
      );
    },
