...
class ImagePath {
  ...
  //Images
  static const String DEV = "assets/images/Group 1171275833.png";
  

  static const String VYBZ = "$imageDir/vybz.jpg";
  static const String COLOSSAL_TOONS = "$imageDir/colossal_toons.jpg";
  static const String LOGIN_CATALOG = "$imageDir/hugme.png";
  static const String ONBOARDING_APP = "$imageDir/gyncare.png";
  static const String FOODY_BITE = "$imageDir/vibra.png";
  static const String OTP_TEXT_FIELD = "$imageDir/love.png";
